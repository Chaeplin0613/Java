...
public class CustomerDAO { //클래스 생성
	private Customer[] customers; //int a; 고객저장소 //null초기값
	private int cnt=0; //멤버필드 //0초기값
...
//		return cArr;
	...
	public void insert	(Customer c) {
		//저장소에 저장되 노객수가 저장소 크기와 같거나 클 경우
		if(cnt >= customers.length) {
			System.out.println("저장소가 꽉 찼습니다. 현재 고객수는"+cnt+"명 입니다");
			//return;
		} else {
		//여기는 지역변수 자리
